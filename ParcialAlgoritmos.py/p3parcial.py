...
def ordenar_por_nombre_y_especie(jedi):
    return jedi["name"], jedi["species"]


def ordenar_lista(lista):
    return sorted(lista, key=ordenar_por_nombre_y_especie)


lista_ordenada = ordenar_lista(jedis)
for jedi in lista_ordenada:
    print(jedi["name"], "-", jedi["species"])

# b) mostrar toda la información de Ahsoka Tano y Kit Fisto;


def mostrar_informacion_jedi(nombre_jedi, lista):
    for jedi in lista:
        if jedi["name"] == nombre_jedi:
            print("Nombre:", jedi["name"])
            print("Maestros:", jedi["master"])
            print("Colores de sable de luz:", jedi["lightsaber_color"])
...
mostrar_informacion_jedi("Ahsoka Tano", jedis)


print("\nInformación de Kit Fisto:")
mostrar_informacion_jedi("Kit Fisto", jedis)
...
# d mostrar los Jedi de especie humana y twi'le
...
# e Listar todos los Jedi cuyos nombres comienzan con "A"
...
# f mostrar los Jedi que han usado sables de luz de más de un color
def sablecolor():
    colores_sables = []
    for jedi in jedis:
        if jedi["lightsaber_color"] is not None and "/" in jedi["lightsaber_color"]:
            colores_sables.append(jedi["name"])
    return colores_sables


sb = sablecolor()
print(f"usaron sable de luz de más de un color son: {sb}")

# g mostrar los Jedi que han usado sable de luz amarillo o violeta


def amarillo_violeta():
    violeta_amarillo = []
    for jedi in jedis:
        if "lightsaber_color" in jedi:
            if jedi["lightsaber_color"] is not None and ("Purple" in jedi["lightsaber_color"] or "Yellow" in jedi["lightsaber_color"]):
                violeta_amarillo.append(jedi["name"])

    return violeta_amarillo


sbm = amarillo_violeta()
print(f"Los jedis que usaron sable de luz amarillo o violeta fueron {sbm} ")
...
pd = padawansdeQui()
print(f"Los padawan de Qui-Gon Jin son {pd} ")

pm = p_de_mace()
print(f"Los padawan de Mace Windu son {pm}")
    ...
    for jedi in jedis:
        if "rank" in jedi:
            if jedi["rank"] is not None and "Grand Master" in jedi["rank"]:
                j_grandmaster.append(jedi["name"])

    return j_grandmaster


gm = grandmaster()
print(f"Los jedis grand master son {gm}")
